...
print(TwoSumSolution.optimized_two_sum([2, 7, 11, 15], 9))
print(TwoSumSolution.optimized_two_sum([3, 2, 4], 6))
print(TwoSumSolution.optimized_two_sum([3, 3], 6))
print(TwoSumSolution.optimized_two_sum([], 6))
print(TwoSumSolution.optimized_two_sum([1, 2, 3, 4], 25))
